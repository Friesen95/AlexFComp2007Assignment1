<%@ Page Title="Service" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="Assignment1.Services" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    and doing well in my courses. However I do feel comfortable creating Web apps or even Applications involving Java, C# and by the end of this semester C++.
        ...
        <div class="row">
            <div class="col-xs-6"><img src="../images/html-css-js-300x175.png" /></div>
            <div class="col-xs-6"><img src="../images/Java_logo.png" /><img src="../images/2p4i.png" /></div>
        </div>
    </div>
</asp:Content>